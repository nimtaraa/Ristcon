...
return new class extends Migration
{
    ...
    {
        Schema::table('presentation_guidelines', function (Blueprint $table) {
    ...
    {
        Schema::table('presentation_guidelines', function (Blueprint $table) {
            $table->dropForeign('presentation_guidelines_conference_id_foreign');
            $table->dropForeign('presentation_guidelines_edition_id_foreign');
        });
    }
};
