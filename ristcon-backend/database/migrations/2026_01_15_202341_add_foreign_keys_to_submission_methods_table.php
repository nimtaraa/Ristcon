...
return new class extends Migration
{
    ...
    {
        Schema::table('submission_methods', function (Blueprint $table) {
    ...
    {
        Schema::table('submission_methods', function (Blueprint $table) {
            $table->dropForeign('submission_methods_conference_id_foreign');
            $table->dropForeign('submission_methods_edition_id_foreign');
        });
    }
};
